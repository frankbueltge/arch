#!/usr/bin/env python3
"""Build one instance of the work "Arrival", iteration 16, from public USGS data.
...
**What iteration 16 changes here: the pick's name carries its record too, and
...
def build(eventid=None):
    ...
    payload = {
        ...
        "counts": {"added": added, "changed": changed, "removed": removed,
                   ...
                   "feltSrc": main_src,
                   "mainStream": stream_index[main_src.split("/")[0]],
